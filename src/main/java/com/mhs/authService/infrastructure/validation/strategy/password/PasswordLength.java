 ...
 */
package com.mhs.authService.infrastructure.validation.strategy.password;
...
class PasswordLength implements PasswordValidationStrategy{
	...
	public Optional<ValidationError> isValid(String password) {
		if(password.length() < PASSWORD_MIN_LENGTH){
			return Optional.of(new ValidationError("Password must be min 8 characters long!","PASSWORD","PASSWORD_LENGTH"));
		}
