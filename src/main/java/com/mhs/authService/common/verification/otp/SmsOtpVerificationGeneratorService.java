 ...
 */
package com.mhs.authService.common.verification.otp;

import com.mhs.authService.common.verification.otp.exception.SmsOtpBlockedException;
import com.mhs.authService.common.verification.otp.exception.SmsOtpExpiredException;
import com.mhs.authService.common.verification.otp.exception.SmsOtpInvalidException;
import com.mhs.authService.common.verification.otp.store.SmsOtpStore;
import com.mhs.authService.common.verification.otp.strategy.SmsOtpSecurityCodeGenerator;
import com.mhs.authService.common.verification.otp.tracker.SmsOtpAttemptTracker;
