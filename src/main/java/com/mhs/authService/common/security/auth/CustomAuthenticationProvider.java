...
import com.mhs.authService.common.ip.HttpContextIpAddressExtractorService;
...
public class CustomAuthenticationProvider implements AuthenticationProvider {
	...
	private final HttpContextIpAddressExtractorService httpContextIpAddressExtractorService;
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		String ip = httpContextIpAddressExtractorService.detect();
		...
		try{
			...
			if(!userDetails.isEnabled()){
				throw new DisabledException("error: Account is disabled, please verify the verification token that is sent to your email or mobile.");
			}
