...
@Component
@AllArgsConstructor
public class AuthenticationRequestFingerPrintExtractorService implements AuthenticationRequestFingerprintExtractor {

	private final IpAddressResolverService ipAddressResolverService;

	@Override
	public AuthenticationRequestFingerprint extractFrom(HttpServletRequest httpServletRequest) {
